...
const uint64_t DEFAULT_REAL_MEMORY_SIZE = 3; // Размер реальной памяти в страницах
...
const uint64_t DEFAULT_MEMORY_USAGE = 5; // Память, занимаемая процессом в количестве страниц 
